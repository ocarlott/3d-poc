  ...
  constructor(
    ...
    function generate() {
      ...
      if ((mesh.geometry as any).isGeometry) {
        (geometry as any).fromGeometry(mesh.geometry);
      } else {
      ...
      var normalAttribute = geometry.attributes[
        'normal'
      ] as THREE.BufferAttribute;
    ...
    function pushDecalVertex(
      decalVertices: DecalVertex[],
    ...
    function clipGeometry(inVertices: DecalVertex[], plane: THREE.Vector3) {
      var outVertices: DecalVertex[] = [];
